...
?>
   ...
   <form method="post" action="slider_panel.php?action=add" enctype="multipart/form-data">
   <p><label>
   Заголовок: <br>
   ...
   <p><label>
   Краткое описание: <br>
   <textarea class="form-item" id="text" name="intro"></textarea>
   </label></p>
   <p><label>
   Содержание: <br>
   ...
   <p><label>
   Прикрепите фотографию для заднего фона слайда: <br>
